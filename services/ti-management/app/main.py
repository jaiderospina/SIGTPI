"""
SIGTPI — Ti Management
Research work lifecycle, milestones, delay alerts
"""
...
app = FastAPI(
    title="SIGTPI — Ti Management",
    description="Research work lifecycle, milestones, delay alerts",
    version="2.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
